...
if args.word_vectors:
    if os.path.isfile(args.vector_cache):
        ...
        inputs.vocab.load_vectors(args.word_vectors, cache=args.data_cache)
...
for epoch in range(args.epochs):
    ...
    for batch_idx, batch in enumerate(train_iter):
        ...
        loss.backward(); opt.step(); train_loss += loss.data.item() * batch.batch_size
        ...
        if iterations % args.dev_every == 0:
            ...
            for dev_batch_idx, dev_batch in enumerate(dev_iter):
                 ...
                 dev_loss += criterion(answer, dev_batch.label).data.item() * dev_batch.batch_size
